...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/mycompany/icon/course_card.png")), "SỐ KHÓA HỌC HIỆN TẠI", "2", ""));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/mycompany/icon/successcourse_card.png")), "SÓ KHÓA HỌC HOÀN THÀNH", "5", ""));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/mycompany/icon/test_card.png")), "ĐIỂM KIỂM TRA", "95 ĐIỂM", ""));
//          add row table
    ...
    private void initComponents() {
        ...
        table = new com.mycompany.swing.Table();
    ...
    private com.mycompany.swing.Table table;

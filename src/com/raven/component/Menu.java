...
import com.raven.event.EventMouseClick;
...
public class Menu extends javax.swing.JPanel {
    ...
    private EventMouseClick eventMouseClick;
    ...
    public void addEventMouseClick(EventMouseClick event) {
        this.eventMouseClick = event;
        listMenu1.addEventMouseClick(event);
    }
    ...
    private void init() {
        ...
        listMenu1.addEventMouseClick(new EventMouseClick() {
            @Override
            public void selected(int index) {
                System.out.println("Selected index: " + index);

                if (index == 5) { // Logout
                    System.out.println("Bạn vừa chọn Logout");

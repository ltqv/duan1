...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/mycompany/icon/class.png")), "SỐ LỚP ĐANG DẠY", "2", ""));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/mycompany/icon/students.png")), "HỌC SINH HIỆN TẠI ĐANG DẠY", "35", ""));
//          add row table

...
public class TableStatus extends JLabel {
    ...
    public com.mycompany.model.StatusType getType() {
        return type;
    }
    ...
    private com.mycompany.model.StatusType type;

    public void setType(com.mycompany.model.StatusType type) {
        this.type = type;
    ...
    protected void paintComponent(Graphics grphcs) {
        if (type != null) {
            ...
            GradientPaint g;
            if (type == com.mycompany.model.StatusType.PENDING) {
                g = new GradientPaint(0, 0, new Color(186, 123, 247), 0, getHeight(), new Color(167, 94, 236));
            } else if (type == com.mycompany.model.StatusType.APPROVED) {
